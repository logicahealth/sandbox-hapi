...
public class LogicaSearchCoordinatorSvcImpl implements ISearchCoordinatorSvc {
    public static final int DEFAULT_SYNC_SIZE = 250;

    private static final Logger ourLog = LoggerFactory.getLogger(LogicaSearchCoordinatorSvcImpl.class);
     ...
     * Constructor
     */
    public LogicaSearchCoordinatorSvcImpl() {
    ...
    private void populateBundleProvider(LogicaPersistedJpaBundleProvider theRetVal) {
    ...
    private IBundleProvider submitSearch(IDao theCallingDao, SearchParameterMap theParams, String theResourceType, RequestDetails theRequestDetails, String theSearchUuid, ISearchBuilder theSb, String theQueryString) {
        ...
        LogicaPersistedJpaSearchFirstPageBundleProvider retVal = new LogicaPersistedJpaSearchFirstPageBundleProvider(search, theCallingDao, mySearchBuilderFactory, task, theSb, myManagedTxManager, theRequestDetails);
    ...
    private IBundleProvider findCachedQuery(IDao theCallingDao, SearchParameterMap theParams, String theResourceType, RequestDetails theRequestDetails, String theQueryString) {
        ...
        LogicaPersistedJpaBundleProvider foundSearchProvider = txTemplate.execute(t -> {
            ...
            LogicaPersistedJpaBundleProvider retVal = new LogicaPersistedJpaBundleProvider(theRequestDetails, searchToUse.getUuid(), theCallingDao, mySearchBuilderFactory);
