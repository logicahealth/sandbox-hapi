...
import org.hspconsortium.platform.api.controller.FhirMultiTenantController;
import org.hspconsortium.platform.api.DatabaseManager;
import org.hspconsortium.platform.api.DatabaseProperties;
import org.hspconsortium.platform.api.model.TenantInfo;
...
//        }
    ...
    private String returnActiveFhirVersion() {
        if (profile.contains(FhirMultiTenantController.DSTU2_PROFILE_NAME)) {
            return FhirMultiTenantController.DSTU2_PROFILE_NAME;
        } else if (profile.contains(FhirMultiTenantController.STU3_PROFILE_NAME)) {
