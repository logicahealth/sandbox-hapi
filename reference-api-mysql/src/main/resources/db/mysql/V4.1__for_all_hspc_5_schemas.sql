...
BEGIN
  ...
  IF NOT EXISTS(SELECT NULL FROM INFORMATION_SCHEMA.COLUMNS WHERE table_name = 'HFJ_SPIDX_QUANTITY'
							AND table_schema = MYSCHEMANAME AND column_name = 'HASH_VALPREFIX') THEN
